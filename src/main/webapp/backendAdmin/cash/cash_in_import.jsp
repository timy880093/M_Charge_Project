...
<form name="Form1" id="Form1" method="POST" action="<%=request.getContextPath()%>/backendAdmin/uploadServlet"
    ...
    <table>
        <tr>
            <td>
                <label>1:瀏覽/上傳 入帳excel格式(從上海銀行匯出的excel).xls</label>
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <input type="button" id="importBtn" value="匯入入帳資料" onclick="cashIncomeMoneyImport()">
            </td>
        </tr>
...
<script type="text/javascript">
    ...
    //匯入入帳資料
    function cashIncomeMoneyImport(){
