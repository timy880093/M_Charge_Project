<table border="1">
    <tr>
        <td colspan="4">
            <p style="color: brown">級距型檢視合約明細</p>
        </td>
    </tr>
    <tr>
        <td>公司統編：</td>
    ...
    <tr>
        <td colspan="2">是否有級距表：</td>
        <td colspan="2"><input type="text" id="has_grade" disabled></td>
    </tr>
    <tr>
        <td colspan="4">如果有級距表，請自行去方案那裡看，謝謝!!</td>
    </tr>
    <tr>
        <td colspan="2">級距區間費用：</td>
        <td colspan="2"><input type="number" id="grade_price" disabled></td>
    </tr>
    <tr>
        <td colspan="2">級距區間張數：</td>
        <td colspan="2"><input type="number" id="grade_cnt" disabled></td>
    </tr>
    <tr>
        <td colspan="4">
...
//            $("#free_quantity").val(packageMap.free_quantity);
            ...
            $("#has_grade").val(packageMap.has_grade);
            $("#grade_price").val(packageMap.grade_price);
            $("#grade_cnt").val(packageMap.grade_cnt);
        }
    });
