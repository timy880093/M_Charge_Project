...
/**
 * Created by Eason on 6/27/2018.
 */
public class ChargeDetailMonthViewObject {
    String businessNo;
    String companyName;
    String packageName;
    Integer chargeCycle;
    ...
    public Integer getFreeMonthBase() {
        return freeMonthBase;
    }

    public void setFreeMonthBase(Integer freeMonthBase) {
        this.freeMonthBase = freeMonthBase;
    }
