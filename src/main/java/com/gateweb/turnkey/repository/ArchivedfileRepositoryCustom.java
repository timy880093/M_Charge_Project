 ...
 */
@NoRepositoryBean
public interface ArchivedfileRepositoryCustom {
	 ...
	 */
	public List<Archivedfile> searchWithVo(Archivedfile data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<Archivedfile> searchWithVo(Archivedfile data, Pageable pageable) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<Archivedfile> searchLikeVo(Archivedfile data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<Archivedfile> searchLikeVo(Archivedfile data, Pageable pageable) throws DaoSystemException; 
