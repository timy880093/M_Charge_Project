 ...
 */
@NoRepositoryBean
public interface TurnkeySyseventLogRepositoryCustom {
	 ...
	 */
	public List<TurnkeySyseventLog> searchWithVo(TurnkeySyseventLog data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<TurnkeySyseventLog> searchWithVo(TurnkeySyseventLog data, Pageable pageable) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<TurnkeySyseventLog> searchLikeVo(TurnkeySyseventLog data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<TurnkeySyseventLog> searchLikeVo(TurnkeySyseventLog data, Pageable pageable) throws DaoSystemException; 
