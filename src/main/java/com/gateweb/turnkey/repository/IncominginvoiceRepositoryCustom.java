 ...
 */
@NoRepositoryBean
public interface IncominginvoiceRepositoryCustom {
	 ...
	 */
	public List<Incominginvoice> searchWithVo(Incominginvoice data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<Incominginvoice> searchWithVo(Incominginvoice data, Pageable pageable) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<Incominginvoice> searchLikeVo(Incominginvoice data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<Incominginvoice> searchLikeVo(Incominginvoice data, Pageable pageable) throws DaoSystemException; 
