...
public interface ScheduleConfigRepositoryCustom {
	 ...
	 */
	public List<ScheduleConfig> searchWithVo(ScheduleConfig data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<ScheduleConfig> searchWithVo(ScheduleConfig data, Pageable pageable) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<ScheduleConfig> searchLikeVo(ScheduleConfig data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<ScheduleConfig> searchLikeVo(ScheduleConfig data, Pageable pageable) throws DaoSystemException; 
