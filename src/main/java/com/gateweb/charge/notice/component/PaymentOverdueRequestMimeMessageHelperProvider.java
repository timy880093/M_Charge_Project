...
@Component
public class PaymentOverdueRequestMimeMessageHelperProvider implements NoticeMimeMessageHelperProvider {
    protected final Logger logger = LogManager.getLogger(getClass());
    @Autowired
    PaymentRequestMailDataProvider paymentRequestMailDataProvider;
    @Autowired
    PaymentOverdueRequestMailMimeMessageHelperGenerator paymentOverdueRequestMailMimeMessageHelperGenerator;
    @Override
    public Optional<MimeMessageHelper> createHelper(Notice notice) {
        try {
            ...
            return paymentOverdueRequestMailMimeMessageHelperGenerator.genMimeMessageHelper(
