...
@Component
public class OverdueMailSender implements NoticeMimeMessageHelperSender {
    protected org.apache.log4j.Logger logger = LogManager.getLogger(OverdueMailSender.class);
    @Autowired
