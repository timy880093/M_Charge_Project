...
public interface GradeRepositoryCustom {
	 ...
	 */
	public List<GradeEntity> searchWithVo(GradeEntity data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<GradeEntity> searchWithVo(GradeEntity data, Pageable pageable) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<GradeEntity> searchLikeVo(GradeEntity data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<GradeEntity> searchLikeVo(GradeEntity data, Pageable pageable) throws DaoSystemException; 
