 ...
 */
@NoRepositoryBean
public interface CommissionLogRepositoryCustom {
	 ...
	 */
	public List<CommissionLogEntity> searchWithVo(CommissionLogEntity data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<CommissionLogEntity> searchWithVo(CommissionLogEntity data, Pageable pageable) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<CommissionLogEntity> searchLikeVo(CommissionLogEntity data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<CommissionLogEntity> searchLikeVo(CommissionLogEntity data, Pageable pageable) throws DaoSystemException; 
