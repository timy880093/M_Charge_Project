 ...
 */
@NoRepositoryBean
public interface CashDetailRepositoryCustom {
	 ...
	 */
	public List<CashDetailEntity> searchWithVo(CashDetailEntity data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<CashDetailEntity> searchWithVo(CashDetailEntity data, Pageable pageable) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<CashDetailEntity> searchLikeVo(CashDetailEntity data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<CashDetailEntity> searchLikeVo(CashDetailEntity data, Pageable pageable) throws DaoSystemException; 
