 ...
 */
@NoRepositoryBean
public interface WarrantyRepositoryCustom {
	 ...
	 */
	public List<WarrantyEntity> searchWithVo(WarrantyEntity data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<WarrantyEntity> searchWithVo(WarrantyEntity data, Pageable pageable) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<WarrantyEntity> searchLikeVo(WarrantyEntity data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<WarrantyEntity> searchLikeVo(WarrantyEntity data, Pageable pageable) throws DaoSystemException; 
