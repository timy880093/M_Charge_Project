...
public interface DealerRepositoryCustom {
	 ...
	 */
	public List<DealerEntity> searchWithVo(DealerEntity data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<DealerEntity> searchWithVo(DealerEntity data, Pageable pageable) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<DealerEntity> searchLikeVo(DealerEntity data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<DealerEntity> searchLikeVo(DealerEntity data, Pageable pageable) throws DaoSystemException; 
