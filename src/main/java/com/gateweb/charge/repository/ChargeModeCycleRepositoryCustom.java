 ...
 */
@NoRepositoryBean
public interface ChargeModeCycleRepositoryCustom {
	 ...
	 */
	public List<ChargeModeCycleEntity> searchWithVo(ChargeModeCycleEntity data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<ChargeModeCycleEntity> searchWithVo(ChargeModeCycleEntity data, Pageable pageable) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<ChargeModeCycleEntity> searchLikeVo(ChargeModeCycleEntity data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<ChargeModeCycleEntity> searchLikeVo(ChargeModeCycleEntity data, Pageable pageable) throws DaoSystemException; 
