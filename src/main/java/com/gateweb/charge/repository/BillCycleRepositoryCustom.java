 ...
 */
@NoRepositoryBean
public interface BillCycleRepositoryCustom {
	 ...
	 */
	public List<BillCycleEntity> searchWithVo(BillCycleEntity data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<BillCycleEntity> searchWithVo(BillCycleEntity data, Pageable pageable) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<BillCycleEntity> searchLikeVo(BillCycleEntity data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<BillCycleEntity> searchLikeVo(BillCycleEntity data, Pageable pageable) throws DaoSystemException; 
