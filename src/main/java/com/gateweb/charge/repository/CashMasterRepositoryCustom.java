...
public interface CashMasterRepositoryCustom {
	 ...
	 */
	public List<CashMasterEntity> searchWithVo(CashMasterEntity data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<CashMasterEntity> searchWithVo(CashMasterEntity data, Pageable pageable) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<CashMasterEntity> searchLikeVo(CashMasterEntity data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<CashMasterEntity> searchLikeVo(CashMasterEntity data, Pageable pageable) throws DaoSystemException; 
