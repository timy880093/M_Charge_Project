 ...
 */
@NoRepositoryBean
public interface ChargeModeCycleAddRepositoryCustom {
	 ...
	 */
	public List<ChargeModeCycleAddEntity> searchWithVo(ChargeModeCycleAddEntity data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<ChargeModeCycleAddEntity> searchWithVo(ChargeModeCycleAddEntity data, Pageable pageable) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<ChargeModeCycleAddEntity> searchLikeVo(ChargeModeCycleAddEntity data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<ChargeModeCycleAddEntity> searchLikeVo(ChargeModeCycleAddEntity data, Pageable pageable) throws DaoSystemException; 
