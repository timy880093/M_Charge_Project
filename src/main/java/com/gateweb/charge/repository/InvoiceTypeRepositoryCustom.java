 ...
 */
@NoRepositoryBean
public interface InvoiceTypeRepositoryCustom {
	 ...
	 */
	public List<InvoiceTypeEntity> searchWithVo(InvoiceTypeEntity data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<InvoiceTypeEntity> searchWithVo(InvoiceTypeEntity data, Pageable pageable) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<InvoiceTypeEntity> searchLikeVo(InvoiceTypeEntity data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<InvoiceTypeEntity> searchLikeVo(InvoiceTypeEntity data, Pageable pageable) throws DaoSystemException; 
