...
public interface InvoiceMainRepositoryCustom {
	 ...
	 */
	public List<InvoiceMainEntity> searchWithVo(InvoiceMainEntity data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<InvoiceMainEntity> searchWithVo(InvoiceMainEntity data, Pageable pageable) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<InvoiceMainEntity> searchLikeVo(InvoiceMainEntity data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<InvoiceMainEntity> searchLikeVo(InvoiceMainEntity data, Pageable pageable) throws DaoSystemException; 
