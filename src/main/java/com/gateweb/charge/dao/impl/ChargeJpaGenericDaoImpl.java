 ...
 */
@Repository
public abstract class ChargeJpaGenericDaoImpl<T extends Serializable, PrimaryKey extends Serializable> implements JpaGenericDao<T, PrimaryKey> {
	/**
	...
	public ChargeJpaGenericDaoImpl() {
