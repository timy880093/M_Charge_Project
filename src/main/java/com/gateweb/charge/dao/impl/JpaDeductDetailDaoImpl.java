...
public class JpaDeductDetailDaoImpl extends JpaGenericDaoImpl<DeductDetailEntity,       java.lang.Integer       >  implements DeductDetailDao{
    ...
    */
	public void delete(
		...
		logger.debug("JpaDeductDetailDaoImpl delete  begin "
			+"id="+deductDetailId
		);	
		try {
	...
	public List<DeductDetailEntity> searchByProperty(String propertyName,
		...
		logger.debug("JpaDeductDetailDaoImpl findByProperty   queryString :   "+queryString);
		try {
	...
	public List<DeductDetailEntity> searchBy(DeductDetailEntity data) {
		...
		try {
			logger.debug("JpaDeductDetailDaoImpl searchBy  query : "+sb.toString());
	...
	public List<DeductDetailEntity> searchLike(DeductDetailEntity data) {
		...
		List<DeductDetailEntity> results;
		try {
			logger.debug("JpaDeductDetailDaoImpl searchLike  query : "+sb.toString());
			q = entityManager.createQuery(sb.toString());
		} catch (IllegalStateException ise){
			//	RuntimeException
			ise.printStackTrace();
