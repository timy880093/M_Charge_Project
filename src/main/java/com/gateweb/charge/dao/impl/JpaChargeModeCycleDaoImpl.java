...
public class JpaChargeModeCycleDaoImpl extends JpaGenericDaoImpl<ChargeModeCycleEntity,          java.lang.Integer           >  implements ChargeModeCycleDao{

	/**
	 *
	 */
	public JpaChargeModeCycleDaoImpl(){
	}
    ...
    */
	public void delete(
		...
		try {
			Object data = entityManager.find(ChargeModeCycleEntity.class
			, chargeId
			);
	...
	public List<ChargeModeCycleEntity> getSome(int pageNo, int noRowsPerPage)
		{
		List<ChargeModeCycleEntity> results = new ArrayList();
		Query q;
		try {
			q = entityManager.createQuery("select obj from ChargeModeCycleEntity obj ");
		} catch (IllegalStateException ise){
			//	RuntimeException
			ise.printStackTrace();
			throw new DaoSystemException("JPA10001-"+ise.getMessage(),ise);
	...
	@SuppressWarnings("unchecked")
	public List<ChargeModeCycleEntity> searchByProperty(String propertyName,
	...
	@SuppressWarnings("unchecked")
	public List<ChargeModeCycleEntity> searchBy(ChargeModeCycleEntity data) {
		StringBuffer sb = new StringBuffer("select obj from ChargeModeCycleEntity obj where 1=1 ");
		...
		if ( data.getFreeQuantity() != null ) {
			sb.append(" AND obj.freeQuantity = :freeQuantity "); //java.lang.Integer
		}
		if ( data.getSinglePrice() != null ) {
			sb.append(" AND obj.singlePrice = :singlePrice "); //java.math.BigDecimal
		}
		if ( data.getMaxPrice() != null ) {
			sb.append(" AND obj.maxPrice = :maxPrice "); //java.lang.Integer
		}
		...
		if ( data.getPrepaidAdditionEnable() != null ) {
			sb.append(" AND obj.prepaidAdditionEnable = :prepaidAdditionEnable "); //java.lang.Integer
		}
		...
		if ( data.getFreeQuantity() != null ) {
			q.setParameter("freeQuantity", data.getFreeQuantity());
		}
		if ( data.getSinglePrice() != null ) {
			q.setParameter("singlePrice", data.getSinglePrice());
		}
		if ( data.getMaxPrice() != null ) {
			q.setParameter("maxPrice", data.getMaxPrice());
		}
		if ( data.getFreeMonth() != null ) {
		...
		if ( data.getPrepaidAdditionEnable() != null ) {
			q.setParameter("prepaidAdditionEnable", data.getPrepaidAdditionEnable());
		}
		if ( data.getStatus() != null ) {
	...
	@SuppressWarnings("unchecked")
	public List<ChargeModeCycleEntity> searchLike(ChargeModeCycleEntity data) {
		StringBuffer sb = new StringBuffer("select obj from ChargeModeCycleEntity obj where 1=1 ");
		...
		if ( data.getFreeQuantity() != null && !"".equals(data.getFreeQuantity())) {
			sb.append(" AND obj.freeQuantity Like :freeQuantity "); //java.lang.Integer
		}
		if ( data.getSinglePrice() != null ) {
			sb.append(" AND obj.singlePrice >= :singlePrice "); // java.math.BigDecimal
		}
		if ( data.getMaxPrice() != null && !"".equals(data.getMaxPrice())) {
			sb.append(" AND obj.maxPrice Like :maxPrice "); //java.lang.Integer
		}
		...
		if ( data.getPrepaidAdditionEnable() != null && !"".equals(data.getPrepaidAdditionEnable())) {
			sb.append(" AND obj.prepaidAdditionEnable Like :prepaidAdditionEnable "); //java.lang.Integer
		}
