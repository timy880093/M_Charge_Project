...
public class JpaPrepayDeductMasterDaoImpl extends JpaGenericDaoImpl<PrepayDeductMasterEntity,     java.lang.Integer      >  implements PrepayDeductMasterDao{
    ...
    */
	public void delete(
		...
		log.debug("JpaPrepayDeductMasterDaoImpl delete  begin "
	...
	public List<PrepayDeductMasterEntity> searchByProperty(String propertyName,
		...
		log.debug("JpaPrepayDeductMasterDaoImpl findByProperty   queryString :   "+queryString);
		try {
	...
	public List<PrepayDeductMasterEntity> searchBy(PrepayDeductMasterEntity data) {
		...
		try {
			log.debug("JpaPrepayDeductMasterDaoImpl searchBy  query : "+sb.toString());
	...
	public List<PrepayDeductMasterEntity> searchLike(PrepayDeductMasterEntity data) {
		...
		List<PrepayDeductMasterEntity> results;
		try {
			log.debug("JpaPrepayDeductMasterDaoImpl searchLike  query : "+sb.toString());
			q = entityManager.createQuery(sb.toString());
		} catch (IllegalStateException ise){
			//	RuntimeException
			ise.printStackTrace();
