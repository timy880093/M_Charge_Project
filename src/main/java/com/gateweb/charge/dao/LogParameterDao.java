 ...
 */
public interface LogParameterDao extends GenericDao<LogParameterEntity,     java.lang.Integer > {
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<LogParameterEntity> getSome(int pageNo, int noRowsPerPage) throws DaoSystemException;
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<LogParameterEntity> searchBy(LogParameterEntity data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<LogParameterEntity> searchLike(LogParameterEntity data) throws DaoSystemException; 
