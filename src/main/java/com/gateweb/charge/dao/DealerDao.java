 ...
 */
public interface DealerDao extends GenericDao<DealerEntity,           java.lang.Integer > {
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<DealerEntity> getSome(int pageNo, int noRowsPerPage) throws DaoSystemException;
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<DealerEntity> searchBy(DealerEntity data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<DealerEntity> searchLike(DealerEntity data) throws DaoSystemException; 
