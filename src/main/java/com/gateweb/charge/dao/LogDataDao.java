 ...
 */
public interface LogDataDao extends GenericDao<LogDataEntity,    java.lang.Integer      > {
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<LogDataEntity> getSome(int pageNo, int noRowsPerPage) throws DaoSystemException;
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<LogDataEntity> searchBy(LogDataEntity data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<LogDataEntity> searchLike(LogDataEntity data) throws DaoSystemException; 
