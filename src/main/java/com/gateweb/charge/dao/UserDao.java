 ...
 */
public interface UserDao extends GenericDao<UserEntity,        java.lang.Integer             > {
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<UserEntity> getSome(int pageNo, int noRowsPerPage) throws DaoSystemException;
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<UserEntity> searchBy(UserEntity data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<UserEntity> searchLike(UserEntity data) throws DaoSystemException; 
