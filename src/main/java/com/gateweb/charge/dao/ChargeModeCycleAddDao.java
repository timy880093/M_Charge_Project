 ...
 */
public interface ChargeModeCycleAddDao extends GenericDao<ChargeModeCycleAddEntity,   java.lang.Integer            > {
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<ChargeModeCycleAddEntity> getSome(int pageNo, int noRowsPerPage) throws DaoSystemException;
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<ChargeModeCycleAddEntity> searchBy(ChargeModeCycleAddEntity data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<ChargeModeCycleAddEntity> searchLike(ChargeModeCycleAddEntity data) throws DaoSystemException; 
