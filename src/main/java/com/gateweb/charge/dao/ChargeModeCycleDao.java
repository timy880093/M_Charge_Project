 ...
 */
public interface ChargeModeCycleDao extends GenericDao<ChargeModeCycleEntity,          java.lang.Integer           > {
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<ChargeModeCycleEntity> getSome(int pageNo, int noRowsPerPage) throws DaoSystemException;
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<ChargeModeCycleEntity> searchBy(ChargeModeCycleEntity data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<ChargeModeCycleEntity> searchLike(ChargeModeCycleEntity data) throws DaoSystemException; 
