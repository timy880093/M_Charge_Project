 ...
 */
public interface InvoiceMainDao extends GenericDao<InvoiceMainEntity,                     java.lang.Long                                                            > {
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<InvoiceMainEntity> getSome(int pageNo, int noRowsPerPage) throws DaoSystemException;
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<InvoiceMainEntity> searchBy(InvoiceMainEntity data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<InvoiceMainEntity> searchLike(InvoiceMainEntity data) throws DaoSystemException; 
