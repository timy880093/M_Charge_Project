 ...
 */
public interface GradeDao extends GenericDao<GradeEntity,   java.lang.Integer         > {
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<GradeEntity> getSome(int pageNo, int noRowsPerPage) throws DaoSystemException;
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<GradeEntity> searchBy(GradeEntity data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<GradeEntity> searchLike(GradeEntity data) throws DaoSystemException; 
