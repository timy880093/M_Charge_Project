 ...
 */
public interface InvoiceTypeDao extends GenericDao<InvoiceTypeEntity,      java.lang.String  > {
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<InvoiceTypeEntity> getSome(int pageNo, int noRowsPerPage) throws DaoSystemException;
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<InvoiceTypeEntity> searchBy(InvoiceTypeEntity data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<InvoiceTypeEntity> searchLike(InvoiceTypeEntity data) throws DaoSystemException; 
