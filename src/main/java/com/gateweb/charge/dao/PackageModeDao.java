 ...
 */
public interface PackageModeDao extends GenericDao<PackageModeEntity,         java.lang.Integer          > {
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<PackageModeEntity> getSome(int pageNo, int noRowsPerPage) throws DaoSystemException;
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<PackageModeEntity> searchBy(PackageModeEntity data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<PackageModeEntity> searchLike(PackageModeEntity data) throws DaoSystemException; 
