 ...
 */
public interface PrinterDao extends GenericDao<PrinterEntity,           java.lang.Integer      > {
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<PrinterEntity> getSome(int pageNo, int noRowsPerPage) throws DaoSystemException;
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<PrinterEntity> searchBy(PrinterEntity data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<PrinterEntity> searchLike(PrinterEntity data) throws DaoSystemException; 
