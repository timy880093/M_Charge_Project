 ...
 */
public interface CommissionLogDao extends GenericDao<CommissionLogEntity,         java.lang.Integer             > {
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<CommissionLogEntity> getSome(int pageNo, int noRowsPerPage) throws DaoSystemException;
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<CommissionLogEntity> searchBy(CommissionLogEntity data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<CommissionLogEntity> searchLike(CommissionLogEntity data) throws DaoSystemException; 
