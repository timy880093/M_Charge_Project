 ...
 */
public interface CashDetailDao extends GenericDao<CashDetailEntity,                       java.lang.Integer     > {
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<CashDetailEntity> getSome(int pageNo, int noRowsPerPage) throws DaoSystemException;
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<CashDetailEntity> searchBy(CashDetailEntity data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<CashDetailEntity> searchLike(CashDetailEntity data) throws DaoSystemException; 
