 ...
 */
public interface CashMasterDao extends GenericDao<CashMasterEntity,              java.lang.Integer           > {
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<CashMasterEntity> getSome(int pageNo, int noRowsPerPage) throws DaoSystemException;
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<CashMasterEntity> searchBy(CashMasterEntity data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<CashMasterEntity> searchLike(CashMasterEntity data) throws DaoSystemException; 
