 ...
 */
public interface BillCycleDao extends GenericDao<BillCycleEntity,              java.lang.Integer              > {
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<BillCycleEntity> getSome(int pageNo, int noRowsPerPage) throws DaoSystemException;
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<BillCycleEntity> searchBy(BillCycleEntity data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<BillCycleEntity> searchLike(BillCycleEntity data) throws DaoSystemException; 
