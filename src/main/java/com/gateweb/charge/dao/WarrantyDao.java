 ...
 */
public interface WarrantyDao extends GenericDao<WarrantyEntity,        java.lang.Integer          > {
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<WarrantyEntity> getSome(int pageNo, int noRowsPerPage) throws DaoSystemException;
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<WarrantyEntity> searchBy(WarrantyEntity data) throws DaoSystemException; 
	 ...
	 * @throws DaoSystemException	if system is wrong.	 
	 */
	public List<WarrantyEntity> searchLike(WarrantyEntity data) throws DaoSystemException; 
