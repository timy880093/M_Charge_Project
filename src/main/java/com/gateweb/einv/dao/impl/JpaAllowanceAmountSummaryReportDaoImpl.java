 ...
 * @author pkliu
 *
 * This class provides methods to populate DB Table of AllowanceAmountSummaryReportEntity
 */
@Repository("einvAllowanceAmountSummaryReportEntityDao")
public class JpaAllowanceAmountSummaryReportDaoImpl extends EinvJpaGenericDaoImpl<AllowanceAmountSummaryReportEntity,        Long      > implements AllowanceAmountSummaryReportDao {
	/**
	 *
	 */
