 ...
 */
@Repository
public abstract class EinvJpaGenericDaoImpl<T extends Serializable, PrimaryKey extends Serializable> implements JpaGenericDao<T, PrimaryKey> {
	/**
     ...
     *
     */
	@PersistenceContext(unitName = "einvFacade")
