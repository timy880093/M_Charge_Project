 ...
 * @param <PrimaryKey>
 */
public interface GenericDao<T extends Serializable, PrimaryKey extends Serializable> {
	 ...
	 */
	<P> P retrievegetSingleResult(String ql, Map<String, Object> queryParams, Class<P> clazz);
