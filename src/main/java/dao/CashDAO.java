...
//            SendEmailFileUtils.sendEmail(new String[]{email}, subject, content.toString());
    ...
    public List getInvoiceItemList(List masterList) throws Exception{
        ...
        for(int i=0; i<masterList.size(); i++){
            ...
            CompanyEntity companyEntity = (CompanyEntity)getEntity(CompanyEntity.class, master.getCompanyId());
            String businessNo = companyEntity.getBusinessNo();

            List<CashDetailEntity> cashDetailList = getSearchEntity(CashDetailEntity.class, searchCashDetailEntity);
