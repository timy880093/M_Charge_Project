...
public class PrepayDetailEntity implements Serializable {
    ...
    public void setPrepayDetailId(Integer prepayDetailId) {
    ...
    public boolean equals(Object o) {
        ...
        PrepayDetailEntity that = (PrepayDetailEntity) o;

        if (prepayDetailId != null ? !prepayDetailId.equals(that.prepayDetailId) : that.prepayDetailId != null)
            return false;
    ...
    @Override
    public int hashCode() {
        int result = prepayDetailId != null ? prepayDetailId.hashCode() : 0;
